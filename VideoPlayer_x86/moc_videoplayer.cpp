...
**
** Created: Wed Jun 14 16:21:31 2017
...
static const char qt_meta_stringdata_VideoPlayer[] = {
    "VideoPlayer\0\0sig_GetOneFrame(QImage)\0"
    "decode_timer_timeout()\0"
};

const QMetaObject VideoPlayer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_VideoPlayer,
...
int VideoPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sig_GetOneFrame((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 1: decode_timer_timeout(); break;
        default: ;
        }
        _id -= 2;
    }
